...
public class SuggestedAnimeDataSource extends PageKeyedDataSource<Integer, AnimeObject> {
    ...
    public SuggestedAnimeDataSource(Context context)
    {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, AnimeObject> callback) {
        SingletonQueue.getSingleton(context).addToRequestQueue(AppConfig.getAccessApi().suggestedAnime(PAGE_SIZE, OFFSET, new AccessAPI.GeneralAnimeListener() {
            @Override
    ...
    public void loadBefore(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, AnimeObject> callback) {
        SingletonQueue.getSingleton(context).addToRequestQueue(AppConfig.getAccessApi().suggestedAnime(PAGE_SIZE, params.key, new AccessAPI.GeneralAnimeListener() {
            @Override
            public void onResponse(String response) {
