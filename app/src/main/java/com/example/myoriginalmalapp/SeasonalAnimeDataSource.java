...
public class SeasonalAnimeDataSource extends PageKeyedDataSource<Integer, AnimeObject> {
    ...
    public SeasonalAnimeDataSource(Context context, String season, int year)
    {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, AnimeObject> callback) {
        SingletonQueue.getSingleton(context).addToRequestQueue(AppConfig.getAccessApi().SeasonalAnimeList(season, String.valueOf(year), PAGE_SIZE, OFFSET, new AccessAPI.GeneralAnimeListener() {
            @Override
    ...
    public void loadBefore(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, AnimeObject> callback) {
        SingletonQueue.getSingleton(context).addToRequestQueue(AppConfig.getAccessApi().SeasonalAnimeList(season, String.valueOf(year), PAGE_SIZE, params.key, new AccessAPI.GeneralAnimeListener() {
            @Override
            public void onResponse(String response) {
